...
test_audit() {
    ...
    echo 'log_group=secaudit' >>/etc/audit/auditd.conf
    mkdir -p /var/tmp/audit_log_root_owned
    touch /var/tmp/audit_log_root_owned/foo.log
    chgrp secaudit /var/tmp/audit_log_root_owned/foo.log
